    ...
    var adapter = {
        ...
        create: function (connectionName, collectionName, data, cb, connection) {
            ...
            function __CREATE__(connection, cb) {
                ...
                function __INSERT__() {
                    ...
                    connection.query(sql.parse(_query.query), _query.values, function (err, result) {
                        if (err) return cb(handleQueryError(err));
            ...
            function __CREATE_EACH_ITEM__(connection, cb) {
                ...
                async.eachSeries(valuesList,
                    ...
                    function (data, cb) {
                        ...
                        connection.query(sql.parse(_query.query), _query.values, function (err, results) {
                            if (err) return cb(handleQueryError(err));
                    ...
                    $populateBuffers: function populateBuffers(options, next) {
                        ...
                        async.auto({
                                ...
                                processParent: function (next) {
                                    ...
                                    client.query(sql.parse(_query.query[0], instructions)[0], _query.values[0], function __FIND__(err, result) {
                                        if (err) {
                                            return next(err);
                                        }
        ...
        find: function (connectionName, collectionName, options, cb, connection) {
            ...
            function __FIND__(connection, cb) {
                ...
                connection.query(sql.parse(_query.query[0], options)[0], _query.values[0], function (err, result) {
        ...
        update: function (connectionName, collectionName, options, values, cb, connection) {
            ...
            function __UPDATE__(connection, cb) {
                ...
                connection.query(sql.parse(_query.query[0], options)[0], _query.values[0], function (err, results) {
                    if (err) return cb(err);
                    ...
                    connection.query(sql.parse(_query.query), _query.values, function (err, result) {
                        ...
                        connection.query(sql.parse(_query.query[0], criteria)[0], _query.values[0], function (err, result) {
                            if (err) return cb(err);
                            cb(null, result);
                        });
                    });
            ...
            function __DESTROY__(connection, cb) {
                ...
                async.auto({
                        ...
                        destroyRecords: ['findRecords', function (next) {
                            ...
                            connection.query(sql.parse(_query.query), _query.values, next);
                        }]
                    },
